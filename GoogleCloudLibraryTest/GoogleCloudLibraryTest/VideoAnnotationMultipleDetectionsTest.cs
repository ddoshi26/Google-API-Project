...
namespace GoogleClassLibraryTest {
    [TestFixture]
    public class VideoAnnotationMultipleDetectionsTest {
        ...
        [Test]
        public void VideoAnnotationMultipleDetections_InvalidKey() {
            videoIntelligence.UpdateKey(INVALID_SETUP);

            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithMultipleDetections(inputUri: VIDEO_URL);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationMultipleDetections_MissingInputParameters() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithMultipleDetections();
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationMultipleDetections_TooManyInputParameters() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithMultipleDetections(inputUri: VIDEO_URL, inputContent: VIDEO_DATA);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationMultipleDetections_MissingAnnotationParameter() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithMultipleDetections(inputUri: VIDEO_URL);
            response.Wait();

            Assert.IsNull(response.Result.Item1);
            Assert.AreEqual(response.Result.Item2, VideoAnnotationStatus.MISSING_ANNOTATION_FIELD);
        }

        [Test]
        public void VideoAnnotationMultipleDetections_ValidQueryWithExplicitContectAndLabelDetection() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithMultipleDetections(inputUri: VALID_VIDEO_URL, 
                explicitContentDetection: true, labelDetection: true);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationMultipleDetections_ValidQueryWithExplicitContectAndShotChangeDetection() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithMultipleDetections(inputUri: VALID_VIDEO_URL,
                explicitContentDetection: true, shotChangeDetection: true);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationMultipleDetections_ValidQueryWithShotChangeAndLabelDetection() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithMultipleDetections(inputUri: VALID_VIDEO_URL,
                shotChangeDetection: true, labelDetection: true);
            response.Wait();
