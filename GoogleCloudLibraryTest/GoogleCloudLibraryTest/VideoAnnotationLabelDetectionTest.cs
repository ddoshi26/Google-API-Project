...
namespace GoogleClassLibraryTest {
    ...
    [TestFixture]
    public class VideoAnnotationLabelDetectionTest {
        ...
        public VideoAnnotationLabelDetectionTest() {
        ...
        [Test]
        public void VideoAnnotationLabelDetection_InvalidKey() {
            videoIntelligence.UpdateKey(INVALID_SETUP);

            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response = 
                videoIntelligence.AnnotateVideoWithLabelDetection(inputUri: VIDEO_URL);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationLabelDetection_MissingInputParameters() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithLabelDetection();
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationLabelDetection_TooManyInputParameters() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithLabelDetection(inputUri: VIDEO_URL, inputContent: VIDEO_DATA);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationLabelDetection_ValidQuery() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithLabelDetection(inputUri: VALID_VIDEO_URL);
            response.Wait();
