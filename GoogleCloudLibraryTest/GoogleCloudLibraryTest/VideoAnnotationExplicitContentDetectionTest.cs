...
namespace GoogleClassLibraryTest {
    [TestFixture]
    public class VideoAnnotationExplicitContentDetectionTest {
        ...
        public VideoAnnotationExplicitContentDetectionTest() {
        ...
        [Test]
        public void VideoAnnotationExplicitContentDetection_InvalidKey() {
            videoIntelligence.UpdateKey(INVALID_SETUP);

            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithExplicitContentDetection(inputUri: VIDEO_URL);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationExplicitContentDetection_MissingInputParameters() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithExplicitContentDetection();
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationExplicitContentDetection_TooManyInputParameters() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithExplicitContentDetection(inputUri: VIDEO_URL, inputContent: VIDEO_DATA);
            response.Wait();
        ...
        [Test]
        public void VideoAnnotationExplicitContentDetection_ValidQuery() {
            Task<Tuple<VideoAnnotationResponse, ResponseStatus>> response =
                videoIntelligence.AnnotateVideoWithExplicitContentDetection(inputUri: VALID_VIDEO_URL);
            response.Wait();
