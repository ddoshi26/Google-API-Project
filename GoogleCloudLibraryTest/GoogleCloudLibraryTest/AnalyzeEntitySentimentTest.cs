...
namespace GoogleClassLibraryTest {
    [TestFixture]
    public class AnalyzeEntitySentimentTest {
        ...
        public AnalyzeEntitySentimentTest() {
        ...
        [Test]
        public void AnalyzeEntitySentiment_InvalidKey() {
        ...
        [Test]
        public void AnalyzeEntitySentiment_MissingDocument() {
            Task<Tuple<AnalyzeEntitiesResponse, ResponseStatus>> response = nlIntelligence.AnalyzeEntitySentiment(MISSING_DOCUMENT, EncodingType.UTF8);
            response.Wait();
        ...
        [Test]
        public void AnalyzeEntitySentiment_EmptyDocumentContent() {
        ...
        [Test]
        public void AnalyzeEntitySentiment_ValidQueryWithDocumentURL() {
            Document document = new Document(DocumentType.PLAIN_TEXT, googleCloudUri: VALID_DOC_URL);
