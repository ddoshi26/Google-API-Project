...
namespace GoogleClassLibraryTest {
    ...
    public class PlacesPhotosTest {
        ...
        private static readonly String INVALID_FILE_LOCATION = "C:\\Users\\INVALID_FILE_LOCATION\\photo.jpg";
        private static readonly String VALID_FILE_LOCATION = "C:\\Users\\Dhairya\\Desktop\\placesPhoto.jpg";
        private String EDITABLE_VALID_FILE_LOCATION = "C:\\Users\\Dhairya\\Desktop\\placesPhoto";
        ...
        public void PlacesPhotos_MissingPhotoReference() {
            Task<Tuple<String, Places.ResponseStatus>> response = placesPhotos.GetPlacesPhotos(MISSING_PHOTO_REF, VALID_FILE_LOCATION);
            response.Wait();
        ...
        public void PlacesPhotos_InvalidFileDestination() {
            Task<Tuple<String, Places.ResponseStatus>> response = placesPhotos.GetPlacesPhotos(VALID_PHOTO_REF, INVALID_FILE_LOCATION, maxHeight: 400);
            response.Wait();
        ...
        public void PlacesPhotos_MissingHeightWidth() {
            Task<Tuple<String, Places.ResponseStatus>> response = placesPhotos.GetPlacesPhotos(VALID_PHOTO_REF, VALID_FILE_LOCATION);
            response.Wait();
        ...
        public void PlacesPhotos_InvalidPhotoReference() {
            Task<Tuple<String, Places.ResponseStatus>> response = placesPhotos.GetPlacesPhotos(INVALID_PHOTO_REF, VALID_FILE_LOCATION, maxWidth: 500);
            response.Wait();
        ...
        public void PlacesPhotos_ValidQueryWithWidth() {
            Task<Tuple<String, Places.ResponseStatus>> response = placesPhotos.GetPlacesPhotos(VALID_PHOTO_REF, VALID_FILE_LOCATION, maxWidth: 500);
            response.Wait();
        ...
        public void PlacesPhotos_ValidQueryWithHeight() {
            Task<Tuple<String, Places.ResponseStatus>> response = placesPhotos.GetPlacesPhotos(VALID_PHOTO_REF, VALID_FILE_LOCATION, maxHeight: 500);
            response.Wait();
            ...
            for (int i = 0; i < resultList.Results.Count; i++) {
                if (resultList.Results[i].Photos != null && resultList.Results[i].Photos.Count > 0) {
                    ...
                    for (int j = 0; j < photos.Count; j++) {
                        ...
                        Task<Tuple<String, Places.ResponseStatus>> response = placesPhotos.GetPlacesPhotos(photo.Photo_ref, EDITABLE_VALID_FILE_LOCATION + $"_{photoCounter}.jpg", maxHeight: 500);
                        response.Wait();
